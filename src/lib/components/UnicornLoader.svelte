  ...
  <div class="relative {sizeClasses[size]}">
    ...
    <div class="relative unicorn-bounce">
      <svg viewBox="0 0 64 64" class="w-full h-full drop-shadow-lg">
        <defs>
          <linearGradient id="loaderRainbow" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" style="stop-color:#ff6b6b">
              <animate attributeName="stop-color" values="#ff6b6b;#feca57;#48dbfb;#ff9ff3;#a55eea;#ff6b6b" dur="3s" repeatCount="indefinite"/>
            </stop>
            <stop offset="50%" style="stop-color:#48dbfb">
              <animate attributeName="stop-color" values="#48dbfb;#ff9ff3;#a55eea;#ff6b6b;#feca57;#48dbfb" dur="3s" repeatCount="indefinite"/>
            </stop>
            <stop offset="100%" style="stop-color:#a55eea">
              <animate attributeName="stop-color" values="#a55eea;#ff6b6b;#feca57;#48dbfb;#ff9ff3;#a55eea" dur="3s" repeatCount="indefinite"/>
            </stop>
          </linearGradient>
        </defs>
        <!-- Unicorn body -->
        ...
        <path d="M38 24 Q32 20 36 14 Q30 18 34 10 Q28 16 30 8" stroke="url(#loaderRainbow)" stroke-width="3" fill="none" stroke-linecap="round"/>
        <!-- Eye -->
        ...
        <path d="M14 38 Q6 34 8 42 Q2 38 6 46 Q0 44 4 50" stroke="url(#loaderRainbow)" stroke-width="3" fill="none" stroke-linecap="round"/>
      </svg>
    </div>
    
    <!-- Sparkles around unicorn -->
    <div class="absolute -top-2 -left-2 text-yellow-300 sparkle" style="animation-delay: 0s;">&#10022;</div>
    <div class="absolute -top-1 -right-3 text-pink-300 sparkle" style="animation-delay: 0.5s;">&#10022;</div>
    <div class="absolute -bottom-1 -left-3 text-blue-300 sparkle" style="animation-delay: 1s;">&#10022;</div>
    <div class="absolute -bottom-2 -right-2 text-purple-300 sparkle" style="animation-delay: 1.5s;">&#10022;</div>
  </div>
